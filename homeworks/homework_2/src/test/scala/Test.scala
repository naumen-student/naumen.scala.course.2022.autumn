...
object Test extends TestSuite {
  ...
  val tests: Tests = Tests {
    ...
    'test_sumOfDivBy3Or5 - {
      ...
      assert(Exercises.sumOfDivBy3Or5(0, 15) == 3 + 5 + 6 + 9 + 10 + 12 + 15)
      assert(Exercises.sumOfDivBy3Or5(0, 30) == 3 + 5 + 6 + 9 + 10 + 12 + 15 + 18 + 20 + 21 + 24 + 25 + 27 + 30)
    }
    ...
    'test_sumScalars - {
      ...
      assert(Exercises.sumScalars(Vector2D(0, 2), Vector2D(2, 0), Vector2D(0, 2), Vector2D(2, 0)) == 0)
      assert(Exercises.sumScalars(Vector2D(1, 1), Vector2D(1, 1), Vector2D(1, 1), Vector2D(1, 1)) == 4)
      assert(Exercises.sumScalars(Vector2D(9, 5), Vector2D(3, 2), Vector2D(6, 4), Vector2D(7, 1)) == 83)
    }
    ...
    'sortByHeavyweight - {
      assert(Exercises.sortByHeavyweight(Exercises.balls) == Seq("Tin", "Platinum", "Nickel", "Aluminum",
        "Titanium", "Lead", "Sodium", "Uranium", "Gold", "Tungsten", "Zirconium", "Chrome",
        "Iron", "Copper", "Silver", "Plutonium", "Cobalt", "Cesium", "Calcium", "Lithium",
