...
object Test extends TestSuite {
  val tests: Tests = Tests {
    ...
    'test_referenceCellAdvanced {
      val table = new Table(2, 2)
      val cellRef00 = new ReferenceCell(0, 1, table)
      table.setCell(0, 0, cellRef00)
      val cellRef01 = new ReferenceCell(1, 0, table)
      table.setCell(0, 1, cellRef01)
      val cellRef10 = new ReferenceCell(1, 1, table)
      table.setCell(1, 0, cellRef10)
      val cellRef11 = new ReferenceCell(0, 1, table)
      table.setCell(1, 1, cellRef11)

      table.getCell(0, 0).map(_.toString).contains("cyclic")
    }
  }
}
